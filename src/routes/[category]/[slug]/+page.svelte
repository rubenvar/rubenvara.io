...
{#if post}
    <hgroup>
        ...
        <SinglePostMeta date={post.date} updated={post.updated} category={post.category} {categoryCount} />
    </hgroup>
    ...
    {#if post.series}
        <PostSeries currentPostIndex={post.series.index} seriesName={post.series.name} postsInSeries={post.postsInSeries} />
    {/if}

    <SinglePostMeta atBottom={true} date={post.date} updated={post.updated} category={post.category} {categoryCount} />
