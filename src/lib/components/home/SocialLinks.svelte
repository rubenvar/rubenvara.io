...
<div class="links">
    ...
    <a href="https://www.linkedin.com/in/rubenvar" target="_blank"><IconLinkedin />LinkedIn</a>
    {#if dev}<a href="https://twitter.com/rubenvara01" target="_blank"><IconTwitter />Twitter</a>{/if}
